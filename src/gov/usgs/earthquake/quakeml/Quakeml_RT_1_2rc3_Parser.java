...
import org.quakeml_rt_1_2rc3.Quakeml;
...
public class Quakeml_RT_1_2rc3_Parser extends NamespacePrefixMapper {
	 ...
	 */
	private static final NamespacePrefixMapper NAMESPACE_MAPPER = new Quakeml_RT_1_2rc3_Parser();

	public static final String QUAKEML_RT_1_2RC3_BED_NAMESPACE = "http://quakeml.org/xmlns/bed-rt/1.2";
	public static final String QUAKEML_RT_1_2RC3_BED_PREFIX = "";
	public static final String QUAKEML_RT_1_2RC3_NAMESPACE = "http://quakeml.org/xmlns/quakeml-rt/1.2";
	public static final String QUAKEML_RT_1_2RC3_PREFIX = "q";

	public static final JAXBContext CONTEXT;
	static {
		JAXBContext context = null;
		try {
			context = JAXBContext.newInstance("org.quakeml_rt_1_2rc3");
		} catch (Exception e) {
	...
	public String getPreferredPrefix(String namespaceUri, String suggestion,
		...
		if (QUAKEML_RT_1_2RC3_NAMESPACE.equals(namespaceUri)) {
			return QUAKEML_RT_1_2RC3_PREFIX;
		} else if (QUAKEML_RT_1_2RC3_BED_NAMESPACE.equals(namespaceUri)) {
			return QUAKEML_RT_1_2RC3_BED_PREFIX;
		} else {
			return suggestion;
		}
	}
