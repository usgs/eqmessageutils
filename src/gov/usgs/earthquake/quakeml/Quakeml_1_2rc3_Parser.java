 ...
 * @deprecated
 */
public class Quakeml_1_2rc3_Parser extends NamespacePrefixMapper {
	 ...
	 */
	private static final NamespacePrefixMapper NAMESPACE_MAPPER = new Quakeml_1_2rc3_Parser();

	/** Quakeml BED namespace. */
	public static final String QUAKEML_1_2RC3_BED_NAMESPACE = "http://quakeml.org/xmlns/bed/1.2";
	public static final String QUAKEML_1_2RC3_BED_PREFIX = "";

	/** Quakeml namespace. */
	public static final String QUAKEML_1_2RC3_NAMESPACE = "http://quakeml.org/xmlns/quakeml/1.2";
	public static final String QUAKEML_1_2RC3_PREFIX = "q";
	...
	static {
		...
		try {
			context = JAXBContext.newInstance("org.quakeml_1_2rc3");
		} catch (Exception e) {
	...
	public String getPreferredPrefix(String namespaceUri, String suggestion,
		...
		if (QUAKEML_1_2RC3_NAMESPACE.equals(namespaceUri)) {
			return QUAKEML_1_2RC3_PREFIX;
		} else if (QUAKEML_1_2RC3_BED_NAMESPACE.equals(namespaceUri)) {
			return QUAKEML_1_2RC3_BED_PREFIX;
